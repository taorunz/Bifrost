...
# Adapted from TrivialLayout
class CustomLayout(AnalysisPass):
    """Choose a Layout by assigning ``n`` circuit qubits to device qubits ``0, .., n-1``.
    ...
    #MODIFICATION: Adding reordering
    def __init__(self, coupling_map, reordering):
    ...
    def run(self, dag):
        ...
        #MODIFICATION:
        self.property_set["layout"] = Layout.from_intlist(self.reordering, *(list(dag.qregs.values())))
